...
namespace SplineTools
{
    ...
    public class SplineMeshResolutionEditor : Editor
    {
        private bool autoGenerateMesh = true;

        public override void OnInspectorGUI()
        {
            SplineMeshResolution splineMesh = (SplineMeshResolution)target;
            ...
            if (splineMesh.splineContainer != null)
            {
                resolution.arraySize = splineMesh.splineContainer.Splines.Count;
            }
