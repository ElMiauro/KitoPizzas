...
public class PlayerController : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        GetComponentInParent<PathFollower>().enabled = false;
        controller.GetHit();
    ...
    private IEnumerator Recover()
    {
        ...
        state = PlayerState.moving;
        GetComponentInParent<PathFollower>().enabled = true;
        playerArt.GetComponentInChildren<CharacterFlash>().StartFlashing(3);
        canTakeDamage = false;
        animator.CrossFade("Skateboarding", 0.1f);
